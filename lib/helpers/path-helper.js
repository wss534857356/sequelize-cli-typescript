...
module.exports = {
  ...
  getMigrationSourcePath(migrationName) {
    return _path2.default.resolve(this.getMigrationsSourcePath(), this.getFileName('migration', migrationName));
  },

  getMigrationCompiledPath(migrationName) {
    return _path2.default.resolve(this.getMigrationsCompiledPath(), this.getFileName('migration', migrationName));
  },

  getMigrationsSourcePath() {
    return args.migrationsSourcePath || _path2.default.resolve(process.cwd(), 'migrations');
  },

  getMigrationsCompiledPath() {
    return args.migrationsCompiledPath || _path2.default.resolve(process.cwd(), 'migrations/compiled');
  },
  // seeders
  getSeederSourcePath(seederName) {
    return _path2.default.resolve(this.getSeedersSourcePath(), this.getFileName('seeder', seederName));
  },

  getSeederCompiledPath(seederName) {
    return _path2.default.resolve(this.getSeedersCompiledPath(), this.getFileName('seeder', seederName));
  },

  getSeedersSourcePath() {
    return args.seedersSourcePath || _path2.default.resolve(process.cwd(), 'seeders');
  },

  getSeedersCompiledPath() {
    return args.seedersCompiledPath || _path2.default.resolve(process.cwd(), 'seeders/compiled');
  },
  //
