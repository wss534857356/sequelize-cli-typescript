  ...
  return _bluebird2.default.try(() => {
    ...
    const migrator = new _umzug2.default({
      ...
      migrations: {
        ...
        pattern: /\.[jt]s$/,
        customResolver: path => {
          const typescriptSrc = (0, _fs.readFileSync)(path, 'utf8');
          const transpiled = _typescript2.default.transpileModule(typescriptSrc, {});
          const Module = module.constructor;
          const m = new Module(path, module.parent);
          m.filename = path;
          // eslint-disable-next-line no-undef
          m.paths = [...Module._nodeModulePaths((0, _path.dirname)(path)), (0, _resolve2.default)(__dirname, '../../'), (0, _resolve2.default)(__dirname, '../')];
