...
function loadRCFile(optionsPath) {
  var rcFile = optionsPath || _path2.default.resolve(process.cwd(), '.sequelizerc');
  var rcFileResolved = _path2.default.resolve(rcFile);
  return _fs2.default.existsSync(rcFileResolved) ? JSON.parse(JSON.stringify(require(rcFileResolved))) : {};
}

var args = _yargs2.default.config(loadRCFile(_yargs2.default.argv.optionsPath));
